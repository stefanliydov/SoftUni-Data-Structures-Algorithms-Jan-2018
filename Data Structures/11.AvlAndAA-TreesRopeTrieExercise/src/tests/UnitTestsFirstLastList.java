...
public class UnitTestsFirstLastList {
    ...
    public void add2Items_GetCount_ShouldReturn2() {
        // Arrange
        tests.IFirstLastList<Integer> items = new tests.FirstLastList<>();
    ...
    public void add3Items_First2Items_ShouldReturnFirst2Items() {
        // Arrange
        tests.IFirstLastList<Integer> items = FirstLastListFactory.create();
        items.add(5);
        items.add(10);
        items.add(-2);
    ...
    public void add5ItemsDuplicates_First4Items_ShouldReturnFirst4Items() {
        // Arrange
        tests.IFirstLastList<Product> items = FirstLastListFactory.create();
    ...
    public void add3ItemsDuplicates_First3Items_ShouldReturnFirst3Items() {
        // Arrange
        tests.IFirstLastList<String> items = FirstLastListFactory.create();
        items.add("coffee");
        items.add("coffee");
        items.add("milk");
